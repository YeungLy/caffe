...
# ---[ Boost
#SET(Boost_ROOT "/home/amax_yly/anaconda3/envs/caffe27/include/boost")
#SET(Boost_INCLUDE "/home/amax_yly/anaconda3/envs/caffe27/include/boost")
#SET(Boost_LIBRARY "/home/amax_yly/anaconda3/envs/caffe27/lib")
set(Boost_NO_BOOST_CMAKE ON)
find_package(Boost 1.54 REQUIRED COMPONENTS system thread filesystem)
list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${Boost_INCLUDE_DIRS})
list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${Boost_INCLUDE})
...
if(NOT APPLE)
  ...
  elseif(BLAS STREQUAL "MKL" OR BLAS STREQUAL "mkl")
    ...
    message("MKL=${MKL_INCLUDE_DIR}, ${MKL_LIBRARIES}")
...
if(BUILD_python)
  ...
  if(PYTHONLIBS_FOUND AND NUMPY_FOUND AND Boost_FOUND)
